...
def warp_ip():
    ...
    for i, ip in enumerate(best_ipies):
        config_prefix = f"warp://{best_ipies[0]}?ifp=10-20&ifps=20-60&ifpd=5-10Warp 🇮🇷&&detour=warp://{best_ipies[1]}?ifp=10-20&ifps=20-60&ifpd=5-10#WarpInWarp 🇩🇪&&detour= warp://auto?#warp-ir&&detour=warp://auto?#warp-main"
